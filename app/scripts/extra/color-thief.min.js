...
if(ColorThief.prototype.getColor=function(a,b){
  ...
  return d},
  ColorThief.prototype.getPalette=function(a,b,c){"undefined"==typeof b&&(b=6),"undefined"==typeof c&&(c=6);
  for(var d,e,f,g,h,i=new CanvasImage(a),
    j=i.getImageData(),
    k=j.data,
    l=i.getPixelCount(),
    m=[],
    ...
    l>n;
    n+=c)d=4*n,
    e=k[d+0],f=k[d+1],g=k[d+2],h=k[d+3],
    h>=125&&(e>250&&f>250&&g>250||m.push([e,f,g]));

  var o=MMCQ.quantize(m,b),
    p=o.palette();

    return i.removeCanvas(),p},!pv)

  var pv={map:function(a,b){
    var c={};
